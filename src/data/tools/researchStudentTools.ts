...
export const researchStudentTools: AITool[] = [
  ...
  },
  {
    ...
    categories: ['ai-education', 'ai-productivity', 'free-ai-tools', 'ai-research-tools', 'ai-tools-for-students'],
    pricingType: 'free',
    ...
    developerUrl: 'https://labs.google/',
    ...
    iconBg: 'bg-blue-600',
    verifiedDate: 'September 2026',
    useCases: ['Exam study prep', 'Legal document analysis', 'Historical archive synthesis', 'Medical research digestion', 'Podcast Audio Overview'],
    tags: ['NotebookLM', 'Google', 'Research', 'Productivity', 'Audio Overview', 'Google Labs', 'Free AI Tools', 'Study'],
    seoTitle: 'NotebookLM - Grounded AI Research Assistant & Audio Overviews | AI Tool Nest',
    seoDescription: "Discover NotebookLM by Google Labs. Ground your research in up to 50 source documents with zero-hallucination citations and viral two-host Audio Overview podcasts.",
    faqs: [
  ...
  },
  {
    ...
    tagline: 'Developer sandbox and rapid prototyping environment for Gemini 2.0, 1.5 Pro, and Flash',
    ...
    fullDescription: 'Google AI Studio is the fastest path from idea to functional prototype with Gemini models. Designed for developers, tinkerers, and AI builders, it provides direct access to Gemini 2.0 Flash and 1.5 Pro (with up to 2M token context window), offering fine-grained control over temperature, system prompts, structured JSON output, and instant code export in Python, JavaScript, and cURL.',
    category: 'ai-coding',
    categoryLabel: 'AI Development',
    categories: ['ai-coding', 'ai-productivity', 'free-ai-tools', 'ai-research-tools'],
    pricingType: 'freemium',
    ...
    iconBg: 'bg-blue-600',
    verifiedDate: 'September 2026',
    useCases: ['Multimodal video reasoning', 'Extracting structured JSON from unstructured text', 'API prototyping', 'Code generation benchmarking', 'System prompt engineering'],
    tags: ['Google AI Studio', 'Gemini', 'AI Development', 'Developer Tools', 'API Keys', 'Multimodal', 'Prompt Prototyping'],
    seoTitle: 'Google AI Studio - Gemini Prototyping & Developer Sandbox | AI Tool Nest',
    seoDescription: "Google AI Studio is Google's rapid prototyping environment for experimenting with Gemini 2.0 and 1.5 models, structured JSON outputs, and developer API keys.",
    faqs: [
