...
export const researchStudentTools: AITool[] = [
  ...
  },
  {
    ...
    slug: 'github-copilot',
    name: 'GitHub Copilot',
    tagline: 'The world’s most widely adopted AI coding assistant embedded into your IDE',
    description: 'AI code completion and chat tool integrated into VS Code, JetBrains, and Visual Studio to write code, tests, and documentation.',
    fullDescription: 'GitHub Copilot is the premier AI pair programmer. Trained on billions of lines of code, Copilot autocompletes lines and whole functions as you type. With Copilot Chat, developers can explain unfamiliar legacy code, generate unit tests, and fix runtime bugs directly inside their IDE.',
    category: 'ai-productivity-tools',
    categoryLabel: 'AI Productivity & Coding',
    categories: ['ai-productivity-tools', 'free-ai-tools', 'ai-tools-for-students'],
    pricingType: 'freemium',
    pricingSummary: '100% Free for verified students, teachers, and popular open source maintainers; Individual plan starts at $10/month ($100/yr).',
    pricingPlans: [
      {
        name: 'Free for Students & OSS',
        price: '$0',
        billing: 'with GitHub Student Pack',
        popular: true,
        features: ['Full access to Copilot completions', 'Copilot Chat in VS Code and JetBrains', 'CLI terminal assistance', 'Multi-language support']
      },
      {
        name: 'Copilot Individual',
        price: '$10',
        billing: 'per month or $100/year (30-day free trial)',
        features: ['Code completions as you type', 'Copilot Chat in IDE', 'CLI assistance & documentation generation', 'Security vulnerability filters']
      },
      {
        name: 'Copilot Business',
        price: '$19',
        billing: 'per user / month',
        features: ['Organization-wide policy management', 'IP indemnification', 'Zero data retention on business code', 'Audit logs']
      }
    ],
    bestFor: 'Software developers, computer science students, full-stack engineers, and open-source contributors.',
    keyFeatures: [
      'Context-aware autocomplete predicting whole functions and algorithms as you type',
      'Copilot Chat explaining code, diagnosing syntax errors, and generating unit tests inside the editor',
      'Copilot for Pull Requests summarizing diffs and generating commit messages automatically',
      'Multi-IDE support across VS Code, Visual Studio, JetBrains IDEs, and Neovim'
    ],
    pros: [
      '100% free for students through the GitHub Student Developer Pack',
      'Substantially increases developer coding speed on repetitive boilerplate code',
      'Zero context-switching—runs directly in your existing coding editor',
      'Understands dozens of programming languages, frameworks, and syntax variations'
    ],
    cons: [
      'Commercial developers require a paid subscription ($10/mo)',
      'Generated code must still be reviewed by engineers for edge-case correctness'
    ],
    howToUse: [
      { step: 1, title: 'Install IDE Extension', description: 'Add GitHub Copilot from the VS Code or JetBrains plugin marketplace.' },
      { step: 2, title: 'Write Descriptive Comments', description: 'Type `// function to calculate distance between two coordinates` and press Tab.' },
      { step: 3, title: 'Chat to Generate Tests', description: 'Highlight code and ask `@workspace /tests` to create comprehensive unit test suites.' }
    ],
    alternatives: ['Google AI Studio', 'Claude', 'ChatGPT'],
    officialUrl: 'https://github.com/features/copilot',
    affiliateUrl: 'https://github.com/features/copilot',
    hasAffiliate: false,
    rating: 4.9,
    reviewsCount: 55000,
    badges: ['Developer Standard', 'Free for Students'],
    iconName: 'Zap',
    iconBg: 'bg-black',
    verifiedDate: 'September 2026',
    useCases: ['Boilerplate code writing', 'Unit test generation', 'Debugging complex error stacks', 'Refactoring legacy code'],
    faqs: [
      { question: 'Is GitHub Copilot free for students?', answer: 'Yes, GitHub Copilot is 100% free for verified students, teachers, and prominent open-source maintainers via the GitHub Student Developer Pack.' },
      { question: 'What editors does GitHub Copilot support?', answer: 'Copilot supports Visual Studio Code, Visual Studio, all JetBrains IDEs (IntelliJ, PyCharm, WebStorm), and Neovim.' }
    ]
  },
  {
