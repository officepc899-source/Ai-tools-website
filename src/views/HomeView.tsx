...
export const HomeView: React.FC = () => {
  ...
  return (
    <div className="space-y-16 sm:space-y-24 pb-20">
      ...
      <section aria-labelledby="trending-news-heading" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-4 mb-8">
          <div>
            ...
            <h2
              ...
              className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white font-['Space_Grotesk'] tracking-tight"
            >
              Trending AI News & Frontier Updates
            </h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              Stay ahead of frontier model launches, regulatory shifts, and major venture investments.
            </p>
          </div>

          <button
            onClick={() => navigate('/blog')}
            className="text-xs sm:text-sm font-bold text-indigo-600 dark:text-indigo-400 hover:underline cursor-pointer inline-flex items-center gap-1.5 self-start sm:self-auto"
          >
            <span>All AI Dispatches</span>
            <ArrowRight className="w-3.5 h-3.5" />
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            {
              id: 'news-1',
              title: 'OpenAI Previews Next-Generation Reasoning Models with Native Multimodal Tool Execution',
              summary: 'New test-time compute benchmarks demonstrate breakthrough performance in complex mathematics, competitive coding, and automated web task execution.',
              date: 'March 8, 2026',
              source: 'Frontier AI Watch',
              readTime: '4 min read',
              badge: 'Breaking Update',
              badgeColor: 'bg-rose-500 text-white',
              link: '/blog/chatgpt-vs-claude-vs-gemini'
            },
            {
              id: 'news-2',
              title: 'Anthropic Unveils Enterprise Computer Use API with Millisecond Vision Latency',
              summary: 'Claude 3.7 Sonnet introduces human-speed desktop automation, operating browsers and legacy business software with 94.2% completion reliability.',
              date: 'March 6, 2026',
              source: 'Enterprise Tech',
              readTime: '3 min read',
              badge: 'Dev Platform',
              badgeColor: 'bg-indigo-600 text-white',
              link: '/blog/best-ai-productivity-tools'
            },
            {
              id: 'news-3',
              title: 'Open-Weights DeepSeek R2 Achieves Frontier Parity Across 20 Global Benchmarks',
              summary: 'The open-source community surges as new distillation frameworks bring 100B parameter reasoning power directly to local consumer RTX workstations.',
              date: 'March 4, 2026',
              source: 'Open Source AI',
              readTime: '5 min read',
              badge: 'Open Weights',
              badgeColor: 'bg-emerald-600 text-white',
              link: '/blog/free-ai-tools-for-students'
            }
          ].map((item) => (
            <article
              key={item.id}
              onClick={() => navigate(item.link)}
              className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer flex flex-col justify-between group"
            >
      ...
      {/* 8.5. AI GADGETS & DEALS SECTION (AFFILIATE MONETIZATION) */}
      <section aria-labelledby="ai-gadgets-heading" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-4 mb-8">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-50 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300 text-xs font-bold mb-2">
              ...
              <span>Next-Gen Smart Hardware & Deals</span>
            </div>
            <h2
              id="ai-gadgets-heading"
              className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white font-['Space_Grotesk'] tracking-tight"
            >
              Trending AI Gadgets & Hardware
            </h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              Tested AI smart glasses, pocket assistants, MagSafe voice transcribers, and desktop robots.
            </p>
          </div>

          <button
            onClick={() => navigate('/ai-gadgets')}
            className="px-4 py-2.5 rounded-xl text-xs font-bold bg-amber-50 dark:bg-amber-950/80 hover:bg-amber-100 dark:hover:bg-amber-900/60 text-amber-800 dark:text-amber-300 border border-amber-200/80 dark:border-amber-800 transition-all inline-flex items-center gap-2 cursor-pointer self-start sm:self-auto shadow-2xs hover:shadow-xs"
          >
            <span>Explore All AI Gadgets</span>
            <ArrowRight className="w-3.5 h-3.5" />
          </button>
        </div>
              ...
              <div>
                ...
                >
                  ...
                  <div className="absolute bottom-3 left-3 right-3 flex items-end justify-between text-white">
                    <span className="text-[11px] font-semibold text-slate-300">{gadget.brand}</span>
                    <span className="text-lg font-black text-emerald-400 font-['Space_Grotesk']">{gadget.price}</span>
                  </div>
                </div>
